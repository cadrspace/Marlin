...
#define STRING_CONFIG_H_AUTHOR "Artyom V. Poptsov" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "REPLICADR"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 400, 3240 /*405*/,  97 /* 70 */ }
